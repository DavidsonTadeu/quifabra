...
const html = fs.readFileSync('c:/Quifabra/andaime-tubular.html', 'utf8'); 
const top = html.substring(0, html.indexOf('<div class="page-hero">')); 
const bottom = html.substring(html.indexOf('<footer class="footer"'));
...
let result = top + calcContent + bottom;
result = result.replace(/<title>.*?<\/title>/, '<title>Calculadora de Andaimes — Quifabra</title>');
fs.writeFileSync('c:/Quifabra/calculadora.html', result, 'utf8');
console.log('calculadora.html created successfully');
